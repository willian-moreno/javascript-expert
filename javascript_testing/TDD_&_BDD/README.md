...
1. A metodologia de Desenvolvimento Orientado por Testes (Test Driven Development) diz respeito a um ciclo de processo. Primeiro escrevemos um teste que falha, adicionamos a implementação, o teste passa, refatoramos o código, e o fluxo se repete.
2. É sobre refletir e saber quando testar, o que testar.
